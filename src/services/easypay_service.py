...
class EasyPayService:
    ...
    def create_payment_invoice(self, pill):
        ...
        try:
            ...
            customer_name = pill.pilladdress.name or (pill.user.name if pill.user else None) or (pill.user.username if pill.user else None) or 'Guest Customer'
            customer_phone = pill.pilladdress.phone
